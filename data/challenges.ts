...
export const CHALLENGES: Challenge[] = [
  ...
  { id: 7,  category: 'prière',  emoji: '✝️', text: 'Avant de dormir, examinez votre conscience en dix minutes de silence.' },
  ...
  { id: 17, category: 'prière',  emoji: '✝️', text: 'Avant chaque repas aujourd\'hui, bénissez la table avec gratitude.' },
